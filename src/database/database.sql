...
(239, 'ZW', 'ZIMBABWE', 'Zimbabwe', 'ZWE', 716, 263);
    ...
    CREATE TABLE states (
        ...
        FOREIGN KEY (id_countries) REFERENCES countries(code)
        ON UPDATE CASCADE ON DELETE CASCADE
    );


    INSERT INTO states (UF, name, id_countries)
VALUES
('AC', 'Acre', 30),
('AL', 'Alagoas', 30),
('AP', 'Amapá', 30),
...
('ES', 'Espírito Santo', 30),
('GO', 'Goiás', 30),
('MA', 'Maranhão', 30),
('MT', 'Mato Grosso', 30),
('MS', 'Mato Grosso do Sul', 30),
('MG', 'Minas Gerais', 30),
('PA', 'Pará', 30),
('PB', 'Paraíba', 30),
('PR', 'Paraná', 30),
('PE', 'Pernambuco', 30),
('PI', 'Piauí', 30),
('RJ', 'Rio de Janeiro', 30),
('RN', 'Rio Grande do Norte', 30),
('RS', 'Rio Grande do Sul', 30),
('RO', 'Rondônia', 30),
('RR', 'Roraima', 30),
